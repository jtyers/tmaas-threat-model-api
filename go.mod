...
require (
	...
	github.com/jtyers/tmaas-dfd-api v0.1.0
	...
	github.com/jtyers/tmaas-service-util v0.0.0-20230531203144-6ef50c3a54e7
	github.com/jtyers/tmaas-threat-api v0.1.0
