...
require (
	...
	github.com/jtyers/tmaas-dfd-api v0.3.4
	github.com/jtyers/tmaas-model v0.0.0-20230614102655-2c850895e715
	github.com/jtyers/tmaas-service-dao v0.0.0-20230615144957-63ea552f1c1f
